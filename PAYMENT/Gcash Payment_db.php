...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("INSERT INTO cashg(Firstname, Lastname, Email, Address, City, ZipCode, gname,gnumber) VALUES (?, ?, ?, ?, ?, ?,?,?)");

    if ($stmt === false) {
        die("Prepare failed: " . $conn->error);
    }

    $stmt->bind_param("sssssisi", $Firstname, $Lastname, $Email, $Address, $City, $ZipCode, $gname, $gnumber);
