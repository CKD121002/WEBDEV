...
<body>
    ...
    <div class="container">
        <form action="Paymaya_db.php" method="POST">
            <div class="row">
                <div class="column">
                ...
                <div class="column">
                    ...
                    <div class="input-box">
                        <span>PayMaya Name:</span>
                        <input type="text" placeholder="Mar* *****co" name="payname">
                    </div>
                    <div class="input-box">
                        <span>PayMaya Number:</span>
                        <input type="number" placeholder="0912*******" name="paynumber">
                    </div>
