...
if (!isset($_SESSION['semail'])) {
    ...
    // Make sure you have your DB connection $conn here
    // Example:
...
<div class="quantity"><input type="number" value="1" min="1"></div>
        ...
        <div class="order-summary-container" id="order">
            ...
            <div class="right-column">
                ...
                <form id="orderForm" action="../backend/usersdata.php" method="POST">
                    ...
                    <button type="button" class="form-button" onclick="submitOrder()">Submit Order</button>
                </form>
    ...
    <script> // KAY MJ NA PART ITUUU
        ...
        `;
            ...
            // Optional: clear localStorage cart items after submit
            localStorage.clear();
        }
